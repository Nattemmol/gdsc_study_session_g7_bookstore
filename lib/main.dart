...
import 'package:flutter_train/bookData.dart';
import 'package:flutter_train/myBook.dart';
import 'package:flutter_train/myBookWithRating.dart';
...
class _MyBookStoreState extends State<MyBookStore> {
  List<BookData> booksRecommendation = [
    BookData('resource/sememen.jpg', 'Sememen: Sisay Nigusu', 5.6),
    BookData('resource/anthro.jpg', 'Anthro', 4.5),
    BookData('resource/kulf.jpg', 'Yetekolefebet Kulf', 7.3),
    BookData('resource/birkrkta.jpg', 'Birkrkta', 6.2),
  ];
  List<BookData> booksNew = [
    BookData('resource/brain.jpg', 'Brain', 5.6),
    BookData('resource/science.png', 'Science', 4.5),
    BookData('resource/soul.jpg', 'Soul', 7.3),
    BookData('resource/shadow.jpg', 'The Shadow King', 6.2),
  ];
  List<BookData> booksTrending = [
    BookData('resource/keadmas.jpg', 'Keadmas Bashager', 7.5),
    BookData('resource/ethiopia.jpg', 'Ethiopia', 8.2),
    BookData('resource/lelasew.jpg', 'Lela Sew', 5.1),
    BookData('resource/theGirl.jpg', 'The Girl In The Woods', 4.7),
  ];
  @override
